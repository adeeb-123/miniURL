...
const UrlShortner = () => {
  ...
  // state for short url
  const [shortURL, setShortURL] = useState("adeeb-copyupwala");
  ...
  return (
    <div className="w-[100%] md:w-[50%] font-[Poppins] flex flex-col items-center">
      <div className="flex gap-4 md:flex-row flex-col">
        <input
          type="text"
          className="w-[90%] px-4 py-2 text-black"
        ...
        <button
          ...
          className="max-md:w-[20%] bg-blue-500 text-white rounded-lg px-4 py-2"
        >
          Shorten URL
        </button>
      </div>
